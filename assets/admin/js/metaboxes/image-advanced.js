jQuery( function( $ )
{
    ...
    var frame,
        template = $( '#tmpl-video-central-metaboxes-image-advanced' ).html();

    $( 'body' ).on( 'click', '.video-central-metaboxes-image-advanced-upload', function( e )
    {
        e.preventDefault();

        var $uploadButton = $( this ),
            $imageList = $uploadButton.siblings( '.video-central-metaboxes-images' ),
        ...
        if ( !frame )
        {
            frame = wp.media( {
                ...
                multiple : true,
                title    : VideoCentralMetaboxesImageAdvanced.frameTitle,
                library  : {
                    type: 'image'
                }
            } );
        ...
        frame.on( 'select', function()
        {
            ...
            {
                var data = {
                    action			: 'video_central_metaboxes_attach_media',
                    post_id			: $( '#post_ID' ).val(),
