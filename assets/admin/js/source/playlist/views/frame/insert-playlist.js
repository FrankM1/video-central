...
InsertPlaylistFrame = PostFrame.extend({
	...
	bindHandlers: function() {
		...
		this.on( 'content:create:video-central-playlist-playlist-browser', this.createCueContent, this );
		this.on( 'toolbar:create:video-central-playlist-insert-playlist', this.createCueToolbar, this );
	},

	createCueMenu: function( menu ) {
		menu.view.set({
			'video-central-playlist-playlist-separator': new wp.media.View({
				className: 'separator',
				priority: 200
			})
		});
