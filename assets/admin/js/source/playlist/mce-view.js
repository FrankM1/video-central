...
(function( $, wp ) {
	...
	extend = {
		action: 'video_central_playlist_parse_shortcode',
		state: [ 'video-central-playlist-playlists' ],
		...
		edit: function( text, update ) {
			// var state = wp.media.editor.open().setState( 'video-central-playlist-playlists' ),
			// shortcode = wp.shortcode.next( 'video_central', text ).shortcode;
		},
	...
	wp.mce.views.register( 'video_central', extend );
