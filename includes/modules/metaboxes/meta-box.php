...
class Video_Central_Metabox
{
    ...
    function save_post( $post_id )
    {
        ...
        if ( ! wp_verify_nonce( $nonce, "video-central-metaboxes-save-{$this->meta_box['id']}" ) )
            return;
        ...
        foreach ( $this->fields as $field )
        {
            ...
            $new = Video_Central_Metaboxes_Core::filter( 'value', $new, $field, $old );
    ...
    static function normalize( $meta_box )
    {
        ...
        $meta_box = apply_filters( 'video_central_metaboxes_normalize_meta_box', $meta_box );
        $meta_box = apply_filters( "video_central_metaboxes_normalize_{$meta_box['id']}_meta_box", $meta_box );
    ...
    static function get_class_name( $field )
    {
        ...
        $class = 'Video_Central_Metaboxes_' . ucwords( $type ) . '_Field';
