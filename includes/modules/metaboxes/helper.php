...
class Video_Central_Metaboxes_Helper
{
	 ...
	 * This function finds field in meta boxes registered by 'video_central_metaboxes_meta_boxes' filter.
	 *
	...
	public static function find_field( $field_id, $post_id = null ) {
		...
		return Video_Central_Metaboxes_Field::call( 'normalize', $field );
	}
	...
	public static function meta( $key, $args = array(), $post_id = null ) {
		...
		switch ( $args['type'] ) {
			...
			case 'oembed':
				...
				break;
			default:
				$meta = Video_Central_Metaboxes_Field::call( 'get_value', $field, $args, $post_id );
		}
