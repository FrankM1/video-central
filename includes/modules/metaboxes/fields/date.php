 ...
 * Date field class.
 */
class Video_Central_Metaboxes_Date_Field extends Video_Central_Metaboxes_Text_Field
{
	/**
	 * Get field HTML
	 *
	...
	static function html( $meta, $field )
	{
		...
		if( $field['inline'] )
		{
			$output .= '<div class="video-central-metaboxes-date-inline"></div>';
		}
		return $output;
	}
	...
	static function admin_enqueue_scripts()
	{
		...
		{
			if ( file_exists( Video_Central_Metaboxes_DIR . 'js/' . $file_path ) )
			{
				wp_register_script( 'jquery-ui-datepicker-i18n', Video_Central_Metaboxes_JS_URL . $file_path, $deps, '1.8.17', true );
				$deps[] = 'jquery-ui-datepicker-i18n';
				break;
			}
		}

		wp_enqueue_script( 'video-central-metaboxes-date', Video_Central_Metaboxes_JS_URL . 'date.js', $deps, Video_Central_Metaboxes_VER, true );
	}
