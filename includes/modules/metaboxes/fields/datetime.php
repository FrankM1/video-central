 ...
 */
class Video_Central_Metaboxes_Datetime_Field extends Video_Central_Metaboxes_Text_Field {
	...
	public static function admin_register_scripts() {
		...
		wp_register_script( 'video-central-metaboxes-datetime', Video_Central_Metaboxes_JS_URL . 'datetime.js', array( 'jquery-ui-datepicker-i18n', 'jquery-ui-timepicker-i18n' ), Video_Central_Metaboxes_VER, true );
		wp_register_script( 'video-central-metaboxes-date', Video_Central_Metaboxes_JS_URL . 'date.js', array( 'jquery-ui-datepicker-i18n', 'jquery-ui-timepicker-i18n' ), Video_Central_Metaboxes_VER, true );
		wp_register_script( 'video-central-metaboxes-time', Video_Central_Metaboxes_JS_URL . 'time.js', array( 'jquery-ui-timepicker-i18n' ), Video_Central_Metaboxes_VER, true );
		...
		foreach ( $handles as $handle ) {
			self::localize_script( "video-central-metaboxes-$handle", 'Video_Central_Metaboxes_' . ucfirst( $handle ), $data );
		}
	}
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'video-central-metaboxes-datetime' );
	}
	...
	public static function html( $meta, $field ) {
		...
		if ( $field['timestamp'] ) {
			...
			$output .= sprintf(
				'<input type="hidden" name="%s" class="video-central-metaboxes-datetime-timestamp" value="%s">',
		...
		if ( $field['inline'] ) {
			$output .= '<div class="video-central-metaboxes-datetime-inline"></div>';
		}
