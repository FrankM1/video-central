 ...
 */
class Video_Central_Metaboxes_Datetime_Field extends Video_Central_Metaboxes_Input_Field
{
	/**
	...
	static function admin_enqueue_scripts()
	{
		...
		{
			if ( file_exists( Video_Central_Metaboxes_DIR . 'js/' . $date_path ) )
			{
				wp_register_script( 'jquery-ui-datepicker-i18n', Video_Central_Metaboxes_JS_URL . $date_path, array( 'jquery-ui-datepicker' ), '1.8.17', true );
				$deps[] = 'jquery-ui-datepicker-i18n';
				break;
			}
		}

		wp_enqueue_script( 'video-central-metaboxes-datetime', Video_Central_Metaboxes_JS_URL . 'datetime.js', $deps, Video_Central_Metaboxes_VER, true );
		wp_localize_script( 'video-central-metaboxes-datetime', 'Video_Central_Metaboxes_Datetimepicker', array(
			'locale'      => $locale,
	...
	static function normalize( $field )
	{
		...
		$field = Video_Central_Metaboxes_Date_Field::normalize( $field );
	...
	{
		$attributes = Video_Central_Metaboxes_Date_Field::get_attributes( $field, $value );
