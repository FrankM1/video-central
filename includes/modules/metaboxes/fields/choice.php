 ...
 */
abstract class Video_Central_Metaboxes_Choice_Field extends Video_Central_Metaboxes_Field {
	...
	public static function filter_options( $field, $options ) {
		...
		foreach ( $options as &$option ) {
			$option         = apply_filters( 'video_central_metaboxes_option', $option, $field );
			$option->$label = apply_filters( 'video_central_metaboxes_option_label', $option->$label, $option, $field );
		}
		return $options;
	}
