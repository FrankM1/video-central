 ...
 * @uses Video_Central_Metaboxes_Select_Walker
 */
class Video_Central_Metaboxes_Select_Tree_Walker
{
	/**
	 * Field data.
	 * @var string
	...
	function display_level( $options, $parent_id = 0, $active = false )
	{
		...
		$field       = $this->field;
		$meta        = $this->meta;
		$walker      = new Video_Central_Metaboxes_Select_Walker( $this->db_fields, $this->field, $this->meta );
