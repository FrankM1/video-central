...
abstract class Video_Central_Metaboxes_Field {
	...
	public static function show( $field, $saved ) {
		...
		// Cloneable fields
		if ( $field['clone'] ) {
			$field_html = Video_Central_Metaboxes_Clone::html( $meta, $field );
		} // End if().
		else {
	...
	public static function end_html( $meta, $field ) {
		return Video_Central_Metaboxes_Clone::add_clone_button( $field ) . self::call( 'element_description', $field ) . '</div>';
	}
	...
	public static function get_attributes( $field, $value = null ) {
		...
		$attributes['class'] = implode( ' ', array_merge( array( "video-central-metaboxes-{$field['type']}" ), (array) $attributes['class'] ) );
	...
	public static function get_value( $field, $args = array(), $post_id = null ) {
		...
		$value  = Video_Central_Metaboxes_Field::call( $field, 'raw_meta', $post_id );
	...
	public static function get_class_name( $field ) {
		...
		return class_exists( $class ) ? $class : 'Video_Central_Metaboxes_Input_Field';
	}
