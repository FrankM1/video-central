...
class Video_Central_Youtube_Importer {
    ...
    private function import_videos(){
        ...
        foreach( $videos as $video_id ) :
            ...
            // get video details
            $request = video_central_query_youtube_video( $video_id );
            ...
            if( !empty($request) && is_array($request) ) {
	            ...
	            if( 200 == $request['response']['code'] ){
	                ...
	                $video  = video_central_format_youtube_video_entry( $data['data'] );
	                ...
	                if( !is_wp_error($post_id) ){
	                    ...
	                    } else if( video_central_import_categories() ) {
...
video_central()->video_central_youtube_importer = new Video_Central_Youtube_Importer();