...
class Video_Central_Importer_Wizard {
    ...
    public function import_source_tabs(){ 
        ...
        <div class="wizard-wrap" data-step="<?php echo $data_step_current; ?>">
            ...
            <div class="wizard-container">
                ...
                <h1><?php _e('Video Import Wizard', 'video_central'); ?></h1>
            	
            	<div class="progress_bar">
					<hr class="all_steps">
					<hr class="current_steps">
					
					<div class="step <?php if( $current == 'step2' || $current == 'step3' || $current == 'step4' ) { echo 'complete'; } ?> <?php if( $current == 'step1' ) { echo 'current'; } ?>" id="step1" data-step="1">
						<?php _e('Select Source', 'video_central'); ?>
					</div>
					
					<div class="step <?php if( $current == 'step2' || $current == 'step3'  ) { echo 'complete'; } ?> <?php if( $current == 'step2' ) { echo 'current'; } ?>" id="step2" data-step="2">
						<?php _e('Set Parameters', 'video_central'); ?>
					</div>
					
					<div class="step <?php if( $current == 'step4' ) { echo 'complete'; } ?> <?php if( $current == 'step3' ) { echo 'current'; } ?>" id="step3" data-step="3">
						<?php _e('Select Videos & Import', 'video_central'); ?>
					</div>
					
					<div class="step <?php if( $current == 'step4' ) { echo 'current'; } ?>" id="step4" data-step="4">
				...
				<div id="blocks">
					...
					<div class="block" id="block1" <?php if( $current == 'step1' ) { echo 'style="left: 0%;"'; } ?>>
						<div class="wrap video-central-import-source-tab">
							...
							<br />
							<a onclick="window.Video_Central_Import.Wizard_Step_Process(1, 2)" class="button"><?php _e('Start', 'video_central'); ?></a>
						</div>
					</div>
				...
				<div class="block" id="block2">
					<div class="wrap video-central-import-parameters">
						<div class="video-central-import-parameters-description">
							<h2><?php _e('Set Parameters', 'video_central'); ?></h2>
							<p class="description">
					...
					<div class="wrap video-central-import-table">
						<div class="video-central-import-table-description">
							<h2 class="video-central-ajax-response">
								<span class="video-central-ajax-response-task"><?php _e('Select Videos to Import', 'video_central'); ?></span><span class="sep">: </span>
						...
						<a onclick="window.Video_Central_Import.Wizard_Step_Process(3, 2, 'desc')" class="button"><?php _e('Go Back', 'video_central'); ?></a>
 					</div>
				</div>

				<div class="block" id="block4">
					<div class="wrap video-central-import-done">
						<h2><?php _e('Done', 'video_central'); ?></h2>
						<div id="video-central-import-done"><?php do_action('video_central_import_complete'); ?></div>
						<br />
						<a onclick="window.Video_Central_Import.Wizard_Step_Process(4, 1, 'restart')" class="button"><?php _e('Start Over', 'video_central'); ?></a>
						<a href="<?php echo admin_url( 'edit.php?post_type='.video_central_get_video_post_type() ); ?>" class="button"><?php _e('Go to Videos List', 'video_central'); ?></a>
     ...
     * @since 1.0.0
     */
    public function import_onload(){ do_action('video_central_import_onload'); }
