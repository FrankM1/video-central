 ...
 * @subpackage Visual Composer Modules
 * @since 1.0.0
 */
...
class Video_Central_Map_Shortcode {
    ...
    function video_central_single_video () {
    ...
    function video_central_categories () {
    ...
    function video_central_single_category () {
    ...
    function video_central_single_tag () {
    ...
    function video_central_search_form () {
    ...
    function video_central_slider_grid () {
