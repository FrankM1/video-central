...
<script type="text/html" id="tmpl-video-central-videos-browser-list-item">
	...
	<button type="button" class="video-central-videos-media-toggle-button dashicons dashicons-yes" tabindex="0">
		<span class="screen-reader-text"><?php esc_html_e( 'Deselect', 'video_central' ); ?></span>
	</button>
</script>
...
<script type="text/html" id="tmpl-video-central-videos-browser-sidebar">
	<div class="video-central-videos-browser-settings collection-settings">
		<h2><?php esc_html_e( 'Playlist Settings', 'video_central' ); ?></h2>

		<div class="setting">
			<p>
				<label>
					<span><?php esc_html_e( 'Theme', 'video_central' ); ?></span>
		...
		<div class="setting">
			<p>
				<label>
					...
					<span><?php esc_html_e( 'Show Tracklist', 'video_central' ); ?></span>
				</label>
			</p>
		</div>
	</div>
...
<script type="text/html" id="tmpl-video-central-videos-browser-empty">
	<h2><?php esc_html_e( 'No items found.', 'video_central' ); ?></h2>
	<p>
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=' . video_central_get_video_post_type() ) ); ?>"><?php esc_html_e( 'Create a video.', 'video_central' ); ?></a>
	</p>
</script>
