...
function video_central_notice_edit_user_success() {
	...
	<div class="video-central-template-notice updated">
		<p><?php esc_html_e( 'User updated.', 'video_central' ); ?></p>
	</div>
...
function video_central_notice_edit_user_is_super_admin() {
	...
	<div class="video-central-template-notice important">
		<p><?php video_central_is_user_home() || video_central_is_user_home_edit() ? esc_html_e( 'You have super admin privileges.', 'video_central' ) : esc_html_e( 'This user has super admin privileges.', 'video_central' ); ?></p>
	</div>
...
function video_central_edit_user_display_name() {
	...
	<?php foreach ( $public_display as $id => $item ) : ?>
		...
		<option id="<?php echo $id; ?>" value="<?php echo esc_attr( $item ); ?>"<?php selected( $video_central->displayed_user->display_name, $item ); ?>><?php echo $item; ?></option>
...
function video_central_edit_user_blog_role() {
	...
	<select name="role" id="role">
		<option value=""><?php esc_html_e( '&mdash; No role for this site &mdash;', 'video_central' ); ?></option>
...
function video_central_edit_user_videos_role() {
	...
	<select name="video-central-videos-role" id="video-central-videos-role">
		<option value=""><?php esc_html_e( '&mdash; No role for these videos &mdash;', 'video_central' ); ?></option>
