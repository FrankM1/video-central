...
class Video_Central_Admin {
	...
	private function setup_actions() {
		...
		add_action( 'video_central_admin_menu',              array( $this, 'admin_menus'                )     ); // Add menu item to settings menu
		...
		add_filter( 'video_central_map_meta_caps',   array( $this, 'map_settings_meta_caps' ), 10, 4 );
