 ...
 *
 * This file contains the actions that are used through-out Video_Central Admin. They
 * are consolidated here to make searching for them easier, and to help developers
 * understand at a glance the order in which things occur.
 *
 * There are a few common places that additional actions can currently be found
 *
 *  - Video_Central: In {@link Video_Central::setup_actions()} in video_central.php
