 ...
 * with video_central_locate_template(), this allows for easy template overrides.
 *
 * @since 1.0.0
 *
...
/**
 * Call the functions added to the 'video_central_template_stack' filter hook, and return
 ...
 * the use of {@link video_central_locate_template()}. Allows for more generic template
 ...
 * vars 'video_central_user_id' with the displayed user id and 'author_name' with the
 * displayed user's nicename are added.
 *
 * If it's a video edit, WP_Query::video_central_is_video_edit is set to true
 *
 * If it's a view page, WP_Query::video_central_is_view is set to true
 * If it's a search page, WP_Query::video_central_is_search is set to true
 *
 * @since 1.0.0
 *
...
function video_central_parse_query($posts_query)
{
    ...
    if (!empty($video_central_user)) {
        ...
        // User profile
            ...
            $posts_query->video_central_is_single_user_profile = true;
        }
