...
class Radium_Video_Widget extends WP_Widget {
    ...
    <?php
        ...
        <div class="video-central-recent-video-widget">
            ...
            <?php }
                ...
                <article class="grid-item">
                    <div class="grid-thumb">
                        <a title="<?php printf(__('Permanent Link to %s', 'video_central'), get_the_title()); ?>" href="<?php the_permalink(); ?>" data-width="<?php echo $thumb_w; ?>" data-height="<?php echo $thumb_h; ?>">
            ...
            <h4>
                <a title="<?php printf(__('Permanent Link to %s', 'video_central'), get_the_title()); ?>" href="<?php the_permalink(); ?>">
                    <?php the_title(); ?>
                </a>
            </h4>
        </article>
...
/*-----------------------------------------------------------------------------------*/
    ...
    function form( $instance ) {
        ...
        <p><!-- Widget Title: Text Input -->
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'video_central') ?></label>
            <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
        </p>

        <p><!-- Number Input: Text Input -->
            <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e('Number of Posts to Display:', 'video_central') ?></label>
            <input type="text" class="widefat" id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo $this->get_field_name( 'number' ); ?>" value="<?php echo $instance['number']; ?>" />
        </p>

        <p><!-- Description Input: Text Input -->
            <label for="<?php echo $this->get_field_id( 'desc' ); ?>"><?php _e('Description:', 'video_central') ?></label>
