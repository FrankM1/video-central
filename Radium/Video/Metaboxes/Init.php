...
if ( ! class_exists( 'Radium_Video_Metaboxes_Init' ) )
{
     ...
     * @package RW Meta Box
     */
    class Radium_Video_Metaboxes_Init
    {
        /**
        ...
        function admin_enqueue_scripts()
        {
            ...
            wp_enqueue_style( 'video_central', video_central()->admin->css_url  . 'metaboxes/style.css', array(), video_central()->version );
        ...
        static function get_class_name( $field )
        {
            ...
            $class = 'Radium_Video_Metaboxes_Field_' . ucwords( $type );
