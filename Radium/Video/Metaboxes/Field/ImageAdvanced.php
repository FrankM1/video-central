...
if ( ! class_exists( 'Radium_Video_Metaboxes_Field_ImageAdvanced' ) )
{
	class Radium_Video_Metaboxes_Field_ImageAdvanced extends Radium_Video_Metaboxes_Field_Image
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_enqueue_media();
			wp_enqueue_script( 'rwmb-image-advanced', video_central()->admin->js_url  . 'metaboxes/image-advanced.js', array( 'jquery', 'underscore' ), video_central()->version, true );
		...
		{
			$i18n_title = apply_filters( 'rwmb_image_advanced_select_string', _x( 'Select or Upload Images', 'image upload', 'video_central' ), $field );
